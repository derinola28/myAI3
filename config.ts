...
export const AI_NAME = "Pookie";
export const OWNER_NAME = "Oluwaseyi Aderinola";

export const WELCOME_MESSAGE = `Hello! I'm ${AI_NAME}, your personal lifestyle coach created by ${OWNER_NAME}.`
